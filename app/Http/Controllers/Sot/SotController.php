        ...
        $packages = $user->packages
            ->map(function ($package) {
                ...
                return [
                    ...
                    'eg3_theory' => (int) $package->lesson->level->code === 3 && $package->theory_status ? true : false,
                    'eg4_theory' => (int) $package->lesson->level->code === 4 && $package->theory_status ? true : false,
