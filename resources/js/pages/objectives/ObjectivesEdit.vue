<template>
    <div class="w-full">
        <h1 class="text-3xl font-bold mb-4">
            Edit: Lesson {{ objective.lesson }} - Objective {{ objective.number }}
        </h1>
                ...
                <div class="relative">
                    ...
                    >
                        ...
                        <option
                            ...
                            :key="lesson.id"
                            v-text="`${lesson.formatNumber} v${lesson.version} - ${lesson.name}`"
                        ></option>
                    </select>
...
export default {
    ...
    methods: {
        ...
        async update () {
            let { data } = await axios.put(`${this.urlBase}/api/objectives/${this.objective.id}`, this.form)
    ...
    async mounted () {
        ...
        this.form.name_en = this.objective.name_en
        this.form.name_fr = this.objective.name_fr
        this.form.number = this.objective.number
        this.form.lesson_id = this.objective.lesson_id
